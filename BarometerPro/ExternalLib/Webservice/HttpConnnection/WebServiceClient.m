...
+(WebServiceClient*) getWithURL:(NSString *)url success:(void (^)(WebServiceClient *, NSString *))success fail:(void (^)(WebServiceClient *, NSError *))fail
{
...
+(WebServiceClient*) postWithURL:(NSString *)url params:(NSDictionary *)params success:(void (^)(WebServiceClient *, NSString *))success fail:(void (^)(WebServiceClient *, NSError *))fail
{
    WebServiceClient* api = [[WebServiceClient alloc] init];
...
- (void)requestSucceeded:(NSString *)data
{
    ...
    switch (statusCode)
    {
        ...
        default:
        {
            [self requestFailed:[NSError errorWithDomain:data code:self.client.statusCode userInfo:nil]];
